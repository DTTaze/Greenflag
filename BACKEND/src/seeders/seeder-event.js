  ...
  up: async (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert("events", [
      ...
      },
      {
        ...
        description:
          "Chiến dịch thu gom rác thải nhựa tại công viên trung tâm nhằm nâng cao ý thức bảo vệ môi trường.",
      ...
      },
      {
        ...
        description:
          "Hoạt động trồng cây tại khu vực đồi trọc để phục hồi hệ sinh thái và giảm thiểu biến đổi khí hậu.",
      ...
      },
      {
        ...
        description:
          "Vận động người dân hạn chế sử dụng túi nilon và thay bằng túi vải, sản phẩm thân thiện môi trường.",
      ...
      },
      {
        ...
        description:
          "Tình nguyện viên tham gia dọn rác tại bãi biển và tuyên truyền về ô nhiễm đại dương.",
      ...
      },
      {
        ...
        description:
          "Hướng dẫn phân loại và thu gom rác thải điện tử đúng cách để bảo vệ sức khỏe cộng đồng.",
      ...
      },
      {
        ...
        description:
          "Chia sẻ kiến thức và giải pháp ứng phó với biến đổi khí hậu dành cho sinh viên và người dân.",
      ...
      },
      {
        ...
        description:
          "Người dân mang rác tái chế đến để đổi lấy cây xanh và quà tặng thân thiện với môi trường.",
      ...
      },
      {
        ...
        description:
          "Cùng nhau tắt đèn trong một giờ để kêu gọi tiết kiệm năng lượng và bảo vệ Trái Đất.",

...
const nextConfig: NextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_NESTJS_API_URL: process.env.NEXT_PUBLIC_NESTJS_API_URL || "http://localhost:3000",
  ...
  async rewrites() {
    ...
    const nestjsApiUrl = process.env.NEXT_PUBLIC_NESTJS_API_URL || "http://localhost:3000";
    return [
      {
        source: "/api/:path*",

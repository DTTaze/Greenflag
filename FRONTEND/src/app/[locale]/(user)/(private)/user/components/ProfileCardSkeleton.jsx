...
export default function ProfileCardSkeleton() {
  return (
    <div className="relative mx-auto max-w-sm overflow-hidden rounded-lg bg-white p-4 shadow-md dark:bg-gray-800">
      {/* Shimmer layer (light/dark friendly) */}
      <div className="pointer-events-none absolute inset-0">
        <div className="animate-shimmer absolute inset-0 bg-gradient-to-r from-gray-100 via-gray-200 to-gray-100 opacity-60 dark:from-gray-700 dark:via-gray-600 dark:to-gray-700" />
      </div>
      ...
      <div className="flex flex-wrap items-center space-x-4 sm:space-x-6">
        ...
        <div className="flex flex-1 flex-col">
          <div className="mb-2 h-5 w-32 rounded-md bg-gray-200 dark:bg-gray-700" />

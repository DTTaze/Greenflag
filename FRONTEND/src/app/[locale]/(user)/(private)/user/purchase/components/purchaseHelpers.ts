export const statusStyles: Record<string, string> = {
  ready_to_pick: "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300",
  picking: "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300",
  money_collect_picking: "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300",
  ...
  transporting: "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300",
  sorting: "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300",
  delivering: "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300",
  delivered: "bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300",
  money_collect_delivering: "bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300",
  delivery_fail: "bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300",
  waiting_to_return: "bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300",
  return: "bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300",
  return_transporting: "bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300",
  return_sorting: "bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300",
  returning: "bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300",
  return_fail: "bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300",
  returned: "bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300",

  ...
  return (
    <div className="flex flex-col items-center justify-between gap-3 sm:flex-row">
      ...
      <div className="flex overflow-hidden rounded-xl border border-gray-200 bg-white">
        <button
          className={`p-2.5 cursor-pointer transition-colors ${marketListView === "grid" ? "bg-gray-50 text-[#0B6E4F]" : "bg-white text-gray-400"} hover:bg-gray-50`}
        ...
        <button
          className={`p-2.5 cursor-pointer transition-colors ${marketListView === "list" ? "bg-gray-50 text-[#0B6E4F]" : "bg-white text-gray-400"} hover:bg-gray-50`}

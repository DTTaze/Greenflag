    ...
    <div className="relative mt-[6vh] ml-6 flex h-[85vh] w-[300px] [scrollbar-width:thin] [scrollbar-color:#0b6e4f_#f0f0f0] flex-col gap-6 overflow-y-auto rounded-xl bg-[#fafafa] p-5 shadow-[0_4px_15px_rgba(0,0,0,0.08)] transition-all duration-300 max-[1200px]:w-[280px] max-[992px]:ml-4 max-[992px]:w-[250px] max-[992px]:p-[15px] max-[768px]:ml-2.5 max-[768px]:w-[220px] max-[768px]:gap-4 max-[576px]:order-2 max-[576px]:m-[10px_auto] max-[576px]:h-auto max-[576px]:max-h-[50vh] max-[576px]:w-[calc(100%-40px)] [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:rounded-[10px] [&::-webkit-scrollbar-thumb]:bg-brand-emerald [&::-webkit-scrollbar-track]:rounded-[10px] [&::-webkit-scrollbar-track]:bg-[#f0f0f0]">
      ...
      <div className="rounded-[10px] border-l-4 border-brand-emerald bg-[#f5f5f5] p-4 shadow-[inset_0_0_8px_rgba(0,0,0,0.05)]">
        ...
        <div className="flex flex-col gap-3 max-[576px]:flex-row max-[576px]:flex-wrap">
          {/* Coins Display */}
          <div
            className="ease flex cursor-pointer items-center gap-3 rounded-[10px] border-l-3 border-[#f9a826] bg-white p-3 shadow-[0_2px_8px_rgba(0,0,0,0.05)] transition-all duration-300 hover:translate-x-[5px] hover:bg-[#fefaf0] max-[768px]:p-2.5 max-[576px]:min-w-[120px] max-[576px]:flex-1 [&_svg]:h-7 [&_svg]:w-7 [&_svg]:text-brand-emerald"
          ...
          {/* Timer Display */}
          <div className="ease flex items-center gap-3 rounded-[10px] border-l-3 border-[#3498db] bg-white p-3 shadow-[0_2px_8px_rgba(0,0,0,0.05)] transition-all duration-300 hover:translate-x-[5px] hover:bg-[#f0f9ff] max-[768px]:p-2.5 max-[576px]:min-w-[120px] max-[576px]:flex-1 [&_svg]:h-7 [&_svg]:w-7 [&_svg]:text-brand-emerald">
            <Timer />
            <div className="flex flex-1 flex-col">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex items-center gap-3 rounded-lg bg-[#f0f0f0] p-2.5 transition-all duration-200 hover:translate-x-[5px] hover:bg-[#e8e8e8]">
          <div className="flex h-9 w-9 items-center justify-center rounded-full bg-brand-emerald/10 text-brand-emerald [&_svg]:h-5 [&_svg]:w-5">
            <svg
      ...
      <div className="mt-2">
        ...
        <div className="rounded-lg border-l-4 border-brand-emerald bg-[#f5f5f5] p-4">
          <div className="mb-2 inline-block rounded bg-brand-emerald/10 px-2 py-1 text-[12px] font-semibold text-brand-emerald">

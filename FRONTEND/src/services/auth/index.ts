...
export const verifyOtp = async (payload: VerifyOtpPayload): Promise<ApiResponse<any>> => {
  return axiosClient.post("/auth/verify-otp", payload);
};

export const resendEmail = async (payload: ResendEmailPayload): Promise<ApiResponse<any>> => {
  return axiosClient.post("/auth/resend-email", payload);
};

export const forgotPassword = async (payload: ForgotPasswordPayload): Promise<ApiResponse<any>> => {
...
export const changePassword = async (payload: ChangePasswordPayload): Promise<ApiResponse<any>> => {

...
- **Tinh chỉnh giao diện & Ánh xạ Enum Maps:** Xây dựng bộ định dạng ngày tháng tiếng Việt dùng chung [formatDate.ts](file:///d:/CODE%20PLAYGROUND/Projects/Fullstack/TECHSOLVE_2025/FRONTEND/src/utils/formatDate.ts) với dấu fallback `--` thân thiện, ẩn menu danh mục không hợp lệ khỏi sidebar và ánh xạ màu sắc trạng thái giao dịch/nhiệm vụ/sản phẩm tập trung tại [enumMaps.ts](file:///d:/CODE%20PLAYGROUND/Projects/Fullstack/TECHSOLVE_2025/FRONTEND/src/constants/enumMaps.ts) đảm bảo chống crash trang.
